...
namespace BNWCore
{
    public class ModConfig
    {
        ...
        public bool BNWCoreharvestCrops { get; set; } = false;
        public bool BNWCoreharvestCropsIndoorPots { get; set; } = true;
        public bool BNWCoreartifactSpots { get; set; } = true;
        public bool BNWCoreorePan { get; set; } = true;
        public bool BNWCorefruitTrees { get; set; } = true;
