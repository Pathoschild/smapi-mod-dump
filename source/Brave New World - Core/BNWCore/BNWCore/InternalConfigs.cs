...
namespace BNWCore
{
    static class Bomb_Config
    {
        public const bool BreakClumps = true;
        public const bool CollectMinerals = true;
        public const bool DamageFarmers = false;
        public const float Radius = 1.0f;
        public const float Damage = 5.0f;
    }
    static class Seed_Config
    {
        public const bool RegrowableSeeds = true;
        public const int SeedChance = 30;
        public const int MinSeeds = 1;
        public const int MaxSeeds = 1;
    }
    static class Watering_Config
    {
        public const int WateringExperienceAmount = 1;
        public const int WateringChanceToGetXP = 100;
        public const bool ForageSeedWateringGrantsForagingXP = true;
    }
    static class Tools
    {
    ...
    static class Grabber_Config
    {
        public const int harvestCropsRange = -1;
        public const string harvestCropsRangeMode = "Walk";
        public const bool reportYield = false;
        public const bool gainExperience = true;
    }
}