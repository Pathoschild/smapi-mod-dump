...
namespace BNWCore
{
    public class BNWCoreMagicNet : Object
    {
        private float yBob;
        ...
        public class BNWCoreMagicNetSerializable
        {
            ...
            public BNWCoreMagicNetSerializable() { }
            public BNWCoreMagicNetSerializable(BNWCoreMagicNet f) 
            {
                Owner = f.owner.Value;
        ...
        public BNWCoreMagicNet() { }
        public BNWCoreMagicNet(Vector2 tileLocation, int stack = 1) : base(tileLocation, ModEntry.BNWCoreMagicNetId, "Fish Net", true, false, false, false)
        {
            Type = "interactive";
            Stack = stack;
        }
