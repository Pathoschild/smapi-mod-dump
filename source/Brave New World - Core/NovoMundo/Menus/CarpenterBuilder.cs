...
{
    public class Carpenter_Builder : IClickableMenu
    {
        ...
        private Building buildingAt = null;
        private bool flag;
        private bool visible;
        private Building destroyed;
        private Building buildingAt2;
        ...
        public void getFlagsFromBuildings(Building building, out bool flag, out bool visible)
        {
            flag = false;
            visible = CanPaintHouse() && HasPermissionsToPaint(null);
        ...
        public bool isBuildingConstructed(int where, string building)
        {
            if (where == 0)
            {
            ...
            if (where == 1)
                if (Property_Manager.QuarryLand().isBuildingConstructed(building))
                {
                    return true;
                }
            if (where == 2)
                if (Property_Manager.PlantationLand().isBuildingConstructed(building))
                {
                    return true;
                }
            if (where == 3)
                if (Property_Manager.LakeLand().isBuildingConstructed(building))
                {
                    return true;
                }
            return false;
        }
        public void buildingBools(Building building)
        {
            if (building.hasCarpenterPermissions())
            {
                flag = true;
        ...
        public void destroyCheckA(Building destroyed)
        {
        ...
        public void destroyCheckB(Building destroyed)
        {
        ...
        public void destroyCheckC(Building destroyed, out Chest chest)
        {
        ...
        public void destroyCheckD(Building destroyed)
        {
            if (destroyed != null)
            {
        ...
        public void paintingCheckA(Building buildingAt2)
        {
            if (buildingAt2 != null)
            {
        ...
        public void paintingCheckB()
        {

        }

        public Carpenter_Builder(int where)
        {
            this.where = where;
            ...
            if (where == 0)
            {
                ...
                int numberBuildingsConstructed = Game1.getFarm().getNumberBuildingsConstructed("Cabin");
                if (Game1.IsMasterGame && numberBuildingsConstructed < Game1.CurrentPlayerLimit - 1)
                {
                    blueprints.Add(new BluePrint("Stone Cabin"));
                    blueprints.Add(new BluePrint("Plank Cabin"));
                    blueprints.Add(new BluePrint("Log Cabin"));
                }
                if (Game1.getFarm().getNumberBuildingsConstructed("Stable") < numberBuildingsConstructed + 1)
                {
                    blueprints.Add(new BluePrint("Stable"));
                }
                blueprints.Add(new BluePrint("Slime Hutch"));
            }
            pass = isBuildingConstructed(where, "Coop");
            if (pass)
            {
                blueprints.Add(new BluePrint("Big Coop"));
            }
            pass = isBuildingConstructed(where, "Big Coop");
            if (pass)
            {
                blueprints.Add(new BluePrint("Deluxe Coop"));
            }
            pass = isBuildingConstructed(where, "Barn");
            if (pass)
            {
                blueprints.Add(new BluePrint("Big Barn"));
            }
            pass = isBuildingConstructed(where, "Big Barn");
            if (pass)
            {
                blueprints.Add(new BluePrint("Deluxe Barn"));
            }
            pass = isBuildingConstructed(where, "Shed");
            if (pass)
            {
        ...
        private void resetBounds()
        {
            ...
            cancelButton = new ClickableTextureComponent("OK", new Microsoft.Xna.Framework.Rectangle(xPositionOnScreen + width - borderWidth - spaceToClearSideBorder - 64, yPositionOnScreen + maxHeightOfBuildingViewer + 64, 64, 64), null, null, Game1.mouseCursors, Game1.getSourceRectForStandardTileSheet(Game1.mouseCursors, 47), 1f)
            {
                myID = 107,
                leftNeighborID = 104
            };
            ...
            if (where == 0)
            {
                ...
                {
                    buildingBools(building);
                }
            }
            else if(where == 1)
            {
                foreach (Building building in Property_Manager.QuarryLand().buildings)
                {
                    buildingBools(building);
                }
            }
            ...
            {
                foreach (Building building in Property_Manager.PlantationLand().buildings)
                {
                    buildingBools(building);
                }
            }
            ...
            {
                foreach (Building building in Property_Manager.LakeLand().buildings)
                {
                    buildingBools(building);
                }
            }
        ...
        public override void performHoverAction(int x, int y)
        {
            ...
            else
            {
                ...
                if (where == 0)
                {
                    ...
                    buildingAt = Game1.getFarm().getBuildingAt(vector);
                    if (buildingAt == null)
                    {
                        buildingAt = Game1.getFarm().getBuildingAt(new Vector2((Game1.viewport.X + Game1.getOldMouseX(ui_scale: false)) / 64, (Game1.viewport.Y + Game1.getOldMouseY(ui_scale: false) + 128) / 64));
                        if (buildingAt == null)
                        {
                            buildingAt = Game1.getFarm().getBuildingAt(new Vector2((Game1.viewport.X + Game1.getOldMouseX(ui_scale: false)) / 64, (Game1.viewport.Y + Game1.getOldMouseY(ui_scale: false) + 192) / 64));
                        }
                    }
                }
                else if (where == 1)
                {
                    ...
                    buildingAt = Property_Manager.QuarryLand().getBuildingAt(vector);
                    if (buildingAt == null)
                    {
                        buildingAt = Property_Manager.QuarryLand().getBuildingAt(new Vector2((Game1.viewport.X + Game1.getOldMouseX(ui_scale: false)) / 64, (Game1.viewport.Y + Game1.getOldMouseY(ui_scale: false) + 128) / 64));
                        if (buildingAt == null)
                        {
                            buildingAt = Property_Manager.QuarryLand().getBuildingAt(new Vector2((Game1.viewport.X + Game1.getOldMouseX(ui_scale: false)) / 64, (Game1.viewport.Y + Game1.getOldMouseY(ui_scale: false) + 192) / 64));
                        }
                    }
                }
                else if (where == 2)
                {
                    ...
                    buildingAt = Property_Manager.PlantationLand().getBuildingAt(vector);
                    if (buildingAt == null)
                    {
                        buildingAt = Property_Manager.PlantationLand().getBuildingAt(new Vector2((Game1.viewport.X + Game1.getOldMouseX(ui_scale: false)) / 64, (Game1.viewport.Y + Game1.getOldMouseY(ui_scale: false) + 128) / 64));
                        if (buildingAt == null)
                        {
                            buildingAt = Property_Manager.PlantationLand().getBuildingAt(new Vector2((Game1.viewport.X + Game1.getOldMouseX(ui_scale: false)) / 64, (Game1.viewport.Y + Game1.getOldMouseY(ui_scale: false) + 192) / 64));
                        }
                    }
                }
                else if (where == 3)
                {
                    ...
                    buildingAt = Property_Manager.LakeLand().getBuildingAt(vector);
                    if (buildingAt == null)
                    {
                        buildingAt = Property_Manager.LakeLand().getBuildingAt(new Vector2((Game1.viewport.X + Game1.getOldMouseX(ui_scale: false)) / 64, (Game1.viewport.Y + Game1.getOldMouseY(ui_scale: false) + 128) / 64));
                        if (buildingAt == null)
                        {
                            buildingAt = Property_Manager.LakeLand().getBuildingAt(new Vector2((Game1.viewport.X + Game1.getOldMouseX(ui_scale: false)) / 64, (Game1.viewport.Y + Game1.getOldMouseY(ui_scale: false) + 192) / 64));
                        }
                    }
                }
                if (upgrading)
                {
                    if (buildingAt != null && CurrentBlueprint.nameOfBuildingToUpgrade != null && CurrentBlueprint.nameOfBuildingToUpgrade.Equals((string)buildingAt.buildingType.Value))
                    {
        ...
        public override void update(GameTime time)
        {
            ...
            if (where == 0)
            {
                foreach (FarmAnimal value in Game1.getFarm().animals.Values)
                {
                    value.MovePosition(Game1.currentGameTime, Game1.viewport, Game1.getFarm());
                }
            }
            else if (where == 1)
            {
                foreach (FarmAnimal value in Property_Manager.QuarryLand().animals.Values)
                {
                    value.MovePosition(Game1.currentGameTime, Game1.viewport, Property_Manager.QuarryLand());
                }
            }
            else if (where == 2)
            {
                foreach (FarmAnimal value in Property_Manager.PlantationLand().animals.Values)
                {
                    value.MovePosition(Game1.currentGameTime, Game1.viewport, Property_Manager.PlantationLand());
                }
            }
            else if (where == 3)
            {
                foreach (FarmAnimal value in Property_Manager.LakeLand().animals.Values)
                {
                    value.MovePosition(Game1.currentGameTime, Game1.viewport, Property_Manager.LakeLand());
                }
            }
        }
        ...
        public override void receiveLeftClick(int x, int y, bool playSound = true)
        {
            ...
            if (demolishing)
            {
                if (where == 0)
                {
                    ...
                    Action continueDemolish = delegate
                    {
                        if (demolishing && destroyed != null && farm.buildings.Contains(destroyed))
                        {
                            ...
                            {
                                destroyCheckA(destroyed);
                            }
                            else
                            {
                                if (destroyed.indoors.Value != null && destroyed.indoors.Value is Cabin)
                                {
                                    destroyCheckB(destroyed);
                                }
                                else
                                {
                                    destroyCheckC(destroyed, out Chest chest);
                                    if (farm.destroyStructure(destroyed))
                                    {
                                        _ = (int)destroyed.tileY.Value;
                                        _ = (int)destroyed.tilesHigh.Value;
                                        Game1.flashAlpha = 1f;
                ...
                {
                    var farm = Property_Manager.QuarryLand();
                    destroyed = farm.getBuildingAt(new Vector2((Game1.viewport.X + Game1.getOldMouseX(ui_scale: false)) / 64, (Game1.viewport.Y + Game1.getOldMouseY(ui_scale: false)) / 64));
                    Action buildingLockFailed = delegate
                    {
                        if (demolishing)
                ...
                {
                    var farm = Property_Manager.PlantationLand();
                    destroyed = farm.getBuildingAt(new Vector2((Game1.viewport.X + Game1.getOldMouseX(ui_scale: false)) / 64, (Game1.viewport.Y + Game1.getOldMouseY(ui_scale: false)) / 64));
                    Action buildingLockFailed = delegate
                    {
                        if (demolishing)
                ...
                {
                    var farm = Property_Manager.LakeLand();
                    destroyed = farm.getBuildingAt(new Vector2((Game1.viewport.X + Game1.getOldMouseX(ui_scale: false)) / 64, (Game1.viewport.Y + Game1.getOldMouseY(ui_scale: false)) / 64));
                    Action buildingLockFailed = delegate
                    {
                        if (demolishing)
            ...
            if (upgrading)
            {
                if (where == 0)
                {
                    buildingAt = Game1.getFarm().getBuildingAt(new Vector2((Game1.viewport.X + Game1.getOldMouseX(ui_scale: false)) / 64, (Game1.viewport.Y + Game1.getOldMouseY(ui_scale: false)) / 64));
                }
                else if (where == 1)
                {
                    buildingAt = Property_Manager.QuarryLand().getBuildingAt(new Vector2((Game1.viewport.X + Game1.getOldMouseX(ui_scale: false)) / 64, (Game1.viewport.Y + Game1.getOldMouseY(ui_scale: false)) / 64));
                }
                else if (where == 2)
                {
                    buildingAt = Property_Manager.PlantationLand().getBuildingAt(new Vector2((Game1.viewport.X + Game1.getOldMouseX(ui_scale: false)) / 64, (Game1.viewport.Y + Game1.getOldMouseY(ui_scale: false)) / 64));
                }
                else if (where == 3)
                {
                    buildingAt = Property_Manager.LakeLand().getBuildingAt(new Vector2((Game1.viewport.X + Game1.getOldMouseX(ui_scale: false)) / 64, (Game1.viewport.Y + Game1.getOldMouseY(ui_scale: false)) / 64));
                }
                if (buildingAt != null && CurrentBlueprint.name != null && buildingAt.buildingType.Equals(CurrentBlueprint.nameOfBuildingToUpgrade))
                {
                    ...
                    {
                        buildingAt.showUpgradeAnimation(Property_Manager.QuarryLand());
                    }
                    else if (where == 2)
                    {
                        buildingAt.showUpgradeAnimation(Property_Manager.PlantationLand());
                    }
                    else if (where == 3)
                    {
                        buildingAt.showUpgradeAnimation(Property_Manager.LakeLand());
                    }
                    Game1.playSound("axe");
            ...
            if (painting)
            {
                ...
                if (where == 0)
                {
                    ...
                    buildingAt2 = farm_location.getBuildingAt(vector);
                    if (buildingAt2 != null)
                    {
                        paintingCheckA(buildingAt2);
                    }
                    else
                    {
                ...
                {
                    buildingAt2 = Property_Manager.QuarryLand().getBuildingAt(vector);
                    if (!HasPermissionsToPaint(null))
                    {
                        Game1.addHUDMessage(new HUDMessage(Game1.content.LoadString("Strings\\UI:Carpenter_CannotPaint_Permission"), Color.Red, 3500f));
                        return;
                ...
                {
                    buildingAt2 = Property_Manager.PlantationLand().getBuildingAt(vector);
                    if (!HasPermissionsToPaint(null))
                    {
                        Game1.addHUDMessage(new HUDMessage(Game1.content.LoadString("Strings\\UI:Carpenter_CannotPaint_Permission"), Color.Red, 3500f));
                        return;
                ...
                {
                    buildingAt2 = Property_Manager.LakeLand().getBuildingAt(vector);
                    if (!HasPermissionsToPaint(null))
                    {
                        Game1.addHUDMessage(new HUDMessage(Game1.content.LoadString("Strings\\UI:Carpenter_CannotPaint_Permission"), Color.Red, 3500f));
                        return;
            ...
            if (moving)
            {
                if (buildingToMove == null)
                {
                    if (where == 0)
                    {
                        buildingToMove = Game1.getFarm().getBuildingAt(new Vector2((Game1.viewport.X + Game1.getMouseX(ui_scale: false)) / 64, (Game1.viewport.Y + Game1.getMouseY(ui_scale: false)) / 64));
                    }
                    else if (where == 1)
                    {
                        buildingToMove = Property_Manager.QuarryLand().getBuildingAt(new Vector2((Game1.viewport.X + Game1.getMouseX(ui_scale: false)) / 64, (Game1.viewport.Y + Game1.getMouseY(ui_scale: false)) / 64));
                    }
                    else if (where == 2)
                    {
                        buildingToMove = Property_Manager.PlantationLand().getBuildingAt(new Vector2((Game1.viewport.X + Game1.getMouseX(ui_scale: false)) / 64, (Game1.viewport.Y + Game1.getMouseY(ui_scale: false)) / 64));
                    }
                    else if (where == 3)
                    {
                        buildingToMove =Property_Manager.LakeLand().getBuildingAt(new Vector2((Game1.viewport.X + Game1.getMouseX(ui_scale: false)) / 64, (Game1.viewport.Y + Game1.getMouseY(ui_scale: false)) / 64));
                    }
                    if (buildingToMove != null)
                    {
                ...
                else if (Game1.getFarm().buildStructure(buildingToMove, new Vector2((Game1.viewport.X + Game1.getMouseX(ui_scale: false)) / 64, (Game1.viewport.Y + Game1.getMouseY(ui_scale: false)) / 64), Game1.player))
                {
        ...
        public bool tryToBuild()
        {
            if (where == 0)
            {
                return Game1.getFarm().buildStructure(CurrentBlueprint, new Vector2((Game1.viewport.X + Game1.getOldMouseX(ui_scale: false)) / 64, (Game1.viewport.Y + Game1.getOldMouseY(ui_scale: false)) / 64), Game1.player, magicalConstruction);
            }
            else if (where == 1)
            {
                return Property_Manager.QuarryLand().buildStructure(CurrentBlueprint, new Vector2((Game1.viewport.X + Game1.getOldMouseX(ui_scale: false)) / 64, (Game1.viewport.Y + Game1.getOldMouseY(ui_scale: false)) / 64), Game1.player, magicalConstruction);
            }
            else if (where == 2)
            {
                return Property_Manager.PlantationLand().buildStructure(CurrentBlueprint, new Vector2((Game1.viewport.X + Game1.getOldMouseX(ui_scale: false)) / 64, (Game1.viewport.Y + Game1.getOldMouseY(ui_scale: false)) / 64), Game1.player, magicalConstruction);
            }
            else if (where == 3)
            {
                return Property_Manager.LakeLand().buildStructure(CurrentBlueprint, new Vector2((Game1.viewport.X + Game1.getOldMouseX(ui_scale: false)) / 64, (Game1.viewport.Y + Game1.getOldMouseY(ui_scale: false)) / 64), Game1.player, magicalConstruction);
            }
            return false;        
        }
        ...
        public void setUpForBuildingPlacement()
        {
            ...
            {
                Game1.currentLocation = Game1.getLocationFromName("NMFarm2");
                Game1.player.viewingLocation.Value = "NMFarm2";
                Game1.currentLocation.resetForPlayerEntry();
            }
            else if (where == 3)
            {
                Game1.currentLocation = Game1.getLocationFromName("NMFarm3");
                Game1.player.viewingLocation.Value = "NMFarm3";
                Game1.currentLocation.resetForPlayerEntry();
            }
        ...
        public virtual bool CanDemolishThis(Building building)
        {
            ...
            {
                _demolishCheckBlueprint = new BluePrint(building.buildingType.Value);
            }
        ...
        public override void draw(SpriteBatch b)
        {
            ...
            {
                base.draw(b);
                drawTextureBox(b, xPositionOnScreen - 96, yPositionOnScreen - 16, maxWidthOfBuildingViewer + 64, maxHeightOfBuildingViewer + 64, magicalConstruction ? Color.RoyalBlue : Color.White);
                currentBuilding.drawInMenu(b, xPositionOnScreen + maxWidthOfBuildingViewer / 2 - (int)currentBuilding.tilesWide.Value * 64 / 2 - 64, yPositionOnScreen + maxHeightOfBuildingViewer / 2 - currentBuilding.getSourceRectForMenu().Height * 4 / 2);
                ...
                drawTextureBox(b, xPositionOnScreen + maxWidthOfBuildingViewer - 16, yPositionOnScreen + 80, num, maxHeightOfBuildingViewer - 32, magicalConstruction ? Color.RoyalBlue : Color.White);
                if (magicalConstruction)
                {
            ...
            else
            {
                ...
                else if (!painting && moving && buildingToMove != null)
                {
                    ...
                    for (int k = 0; k < (int)buildingToMove.tilesHigh.Value; k++)
                    {
                        for (int l = 0; l < (int)buildingToMove.tilesWide.Value; l++)
                        {
