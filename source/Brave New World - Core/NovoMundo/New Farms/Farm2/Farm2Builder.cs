...
{
    public class Farm2_Builder : IClickableMenu
    {
        ...
        public static NMFarm2 getFarm1()
        {
            return Game1.getLocationFromName("NMFarm2") as NMFarm2;
        }

        public Farm2_Builder(bool magicalConstruction = false)
        {
        ...
        public override void performHoverAction(int x, int y)
        {
            ...
            else
            {
                ...
                foreach (Building building in ((NMFarm2)Game1.getLocationFromName("NMFarm2")).buildings)
                {
                    building.color.Value = Color.White;
                }

                Building buildingAt = ((NMFarm2)Game1.getLocationFromName("NMFarm2")).getBuildingAt(vector);
                if (buildingAt == null)
                {
                    buildingAt = ((NMFarm2)Game1.getLocationFromName("NMFarm2")).getBuildingAt(new Vector2((Game1.viewport.X + Game1.getOldMouseX(ui_scale: false)) / 64, (Game1.viewport.Y + Game1.getOldMouseY(ui_scale: false) + 128) / 64));
                    if (buildingAt == null)
                    {
                        buildingAt = ((NMFarm2)Game1.getLocationFromName("NMFarm2")).getBuildingAt(new Vector2((Game1.viewport.X + Game1.getOldMouseX(ui_scale: false)) / 64, (Game1.viewport.Y + Game1.getOldMouseY(ui_scale: false) + 192) / 64));
                    }
                }
        ...
        public override void receiveLeftClick(int x, int y, bool playSound = true)
        {
            ...
            if (demolishing)
            {
                NMFarm2 farm = Game1.getLocationFromName("NMFarm2") as NMFarm2;
            ...
            if (upgrading)
            {
                Building buildingAt = ((NMFarm2)Game1.getLocationFromName("NMFarm2")).getBuildingAt(new Vector2((Game1.viewport.X + Game1.getOldMouseX(ui_scale: false)) / 64, (Game1.viewport.Y + Game1.getOldMouseY(ui_scale: false)) / 64));
            ...
            if (painting)
            {
                NMFarm2 farm_location = getFarm1();
            ...
            if (moving)
            {
                ...
                {
                    buildingToMove = ((NMFarm2)Game1.getLocationFromName("NMFarm2")).getBuildingAt(new Vector2((Game1.viewport.X + Game1.getMouseX(ui_scale: false)) / 64, (Game1.viewport.Y + Game1.getMouseY(ui_scale: false)) / 64));
                    if (buildingToMove != null)
                    {
                ...
                else if (((NMFarm2)Game1.getLocationFromName("NMFarm2")).buildStructure(buildingToMove, new Vector2((Game1.viewport.X + Game1.getMouseX(ui_scale: false)) / 64, (Game1.viewport.Y + Game1.getMouseY(ui_scale: false)) / 64), Game1.player))
                {
        ...
        {
            return ((NMFarm2)Game1.getLocationFromName("NMFarm2")).buildStructure(CurrentBlueprint, new Vector2((Game1.viewport.X + Game1.getOldMouseX(ui_scale: false)) / 64, (Game1.viewport.Y + Game1.getOldMouseY(ui_scale: false)) / 64), Game1.player, magicalConstruction);
        }
