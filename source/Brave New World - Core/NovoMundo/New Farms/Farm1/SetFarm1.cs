...
namespace NovoMundo.Farm1
{
    public class Set_Farm1
    {
        ...
        private NMFarm1 farmExpansion;
        private Map map;
        private XmlSerializer locationSerializer = new XmlSerializer(typeof(NMFarm1));
        private NPC robin;
        ...
        public Set_Farm1(IModHelper helper)
        {
            this.helper = helper;
        }
        ...
        private void Load()
        {
            ...
            {
                loaded = (NMFarm1)locationSerializer.Deserialize(reader);
            }
        ...
        private void RepairBuildingWarps()
        {
            foreach (Building building in farmExpansion.buildings)
            {
                if (building.indoors.Value != null)
                {
                    ...
                    {
                        warps.Add(new Warp(warp.X, warp.Y, "NMFarm1", building.humanDoor.X + building.tileX.Value, building.humanDoor.Y + building.tileY.Value + 1, false));
                    }
