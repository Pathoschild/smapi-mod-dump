...
{
    public class NMFarm1 : Farm
    {
        [System.Xml.Serialization.XmlIgnore]
        private Set_Farm1 framework;
        public NMFarm1(){}
        public NMFarm1(Map m, string name, Set_Farm1 framework) : base(/*"NMFarm1", name*/)
        {
        ...
        public override void UpdateWhenCurrentLocation(GameTime time)
        {
            ...
            if (Game1.player.currentUpgrade != null && Game1.currentLocation.Name.Equals("NMFarm1") && Game1.player.currentUpgrade.daysLeftTillUpgradeDone <= 3)
            {
