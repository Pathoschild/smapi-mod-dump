...
//        ** Fields
//        *********/
//        private static readonly Texture2D Tex = ModEntry.Instance.Helper.ModContent.Load<Texture2D>("FrameworkClothes/assets/mannequin-base.png");
//        private static readonly Texture2D TexM = ModEntry.Instance.Helper.ModContent.Load<Texture2D>("FrameworkClothes/assets/mannequin-male.png");
//        private static readonly Texture2D TexF = ModEntry.Instance.Helper.ModContent.Load<Texture2D>("FrameworkClothes/assets/mannequin-female.png");
...
//        {
//            return ModEntry.Instance.Helper.Translation.Get("mannequin.desc");
//        }
...
//            farmerForRendering.FarmerRenderer.draw(
//                spriteBatch, farmerForRendering.FarmerSprite, 
//                farmerForRendering.FarmerSprite.sourceRect, 
//                farmerForRendering.getLocalPosition(Game1.viewport), 
//                new Vector2(0, farmerForRendering.GetBoundingBox().Height), 
//                drawLayer + 0.001f, Color.White, 0, farmerForRendering);
//        }
...
//        {
//            return ModEntry.Instance.Helper.Translation.Get($"mannequin.name.{this.MannType.Value}-{this.MannGender.Value}");
//        }
