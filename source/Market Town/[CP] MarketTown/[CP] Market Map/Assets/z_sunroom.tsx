...
<tileset version="1.10" tiledversion="1.10.2" name="2" tilewidth="16" tileheight="16" tilecount="128" columns="8">
 <image source="CarolineGreenhouseTiles" width="128" height="256"/>
 <tile id="96">
  <animation>
