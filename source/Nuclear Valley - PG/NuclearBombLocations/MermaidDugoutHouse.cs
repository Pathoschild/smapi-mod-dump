...
{
    [XmlType("Mods_ApryllForever_RestStopLocations_MermaidDugoutHouse")]
    public class MermaidDugoutHouse : NuclearLocation
    {
        [XmlElement("addedMermaidSlimesToday")]
        private readonly NetBool addedMermaidSlimesToday = new NetBool();
        ...
        public MermaidDugoutHouse() { }
        public MermaidDugoutHouse(IModContentHelper content)
        : base(content, "MermaidDugoutHouse", "MermaidDugoutHouse")
        {
         
        }

        public MermaidDugoutHouse(IModHelper helper) 
        {
        ...
        {
            base.initNetFields();
            base.NetFields.AddField(this.addedMermaidSlimesToday, "addedMermaidSlimesToday");
        ...
        protected override void resetSharedState()
        {
            ...
            if ((bool)this.addedMermaidSlimesToday)
            {
                return;
            }
            this.addedMermaidSlimesToday.Value = true;
            Random rand;
            ...
            spawnArea = new Microsoft.Xna.Framework.Rectangle(1, 4, 19, 15);
            for (int tries = 13; tries > 0; tries--)
            {
                Vector2 tile;
        ...
        public override void DayUpdate(int dayOfMonth)
        {
            ...
            this.addedMermaidSlimesToday.Value = false;
