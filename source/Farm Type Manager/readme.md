...
FarmTypes | A list of: "Standard", "Riverland", "Forest", "Hilltop", "Wilderness", "Any"/"All", and/or integers | A list of farm types for which this config file will be used. | This should generally be used in content packs that are combined with custom farm maps; for example, if a custom farm replaces your Standard farm type, set this to `["Standard"]`. This also accept valid "whichFarm" values, e.g. the "ID" from MTN's farmTypes.json files: `[177]`
