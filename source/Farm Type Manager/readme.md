...
SightRange | An integer | The tile distance (in a square pattern) that this monster can see players and become aggressive. | Use -2 or lower to disable aggression completely. -1 might cause automatic aggression, similar to "SeesPlayersAtSpawn".
