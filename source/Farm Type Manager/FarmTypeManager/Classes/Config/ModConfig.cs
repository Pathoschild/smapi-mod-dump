...
namespace FarmTypeManager
{
    public partial class ModEntry : Mod
    {
        ...
        private class ModConfig
        {
            ...
            public bool EnableEPUDebugMessages { get; set; } = false; //allow Expanded Preconditions Utility (EPU) to generate debug-level messages about individual precondition checks
