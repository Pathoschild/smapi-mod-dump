...
- [GMCM 1.12](https://www.nexusmods.com/stardewvalley/mods/5098) (optional, but highly recommended)
...
If you'd like another language to be supported and would like to help, please check the [modding translations wiki](https://stardewvalleywiki.com/Modding:Translations) and send a [pull request](https://github.com/Dunc4nNT/StardewMods/pulls).

## Contact

**Having issues with installing or using the mod?** Leave a comment on the [NexusMods page](https://www.nexusmods.com/stardewvalley/mods/20391?tab=posts) detailing which steps you've done, which step you're failing at and if SMAPI is giving an error, please include a link to your [SMAPI log](https://smapi.io/log).

**Certain you've found a bug?** Please open an [issue](https://github.com/Dunc4nNT/StardewMods/issues) using the bug report template and add the appropriate mod label. If you prefer using Nexus, you can leave a report on the [bug reports page](https://www.nexusmods.com/stardewvalley/mods/20391?tab=bugs). **Uncertain?** Leave a [comment](https://www.nexusmods.com/stardewvalley/mods/20391?tab=posts) first detailing what you've run into, including a link to your [SMAPI log](https://smapi.io/log). **Know what you're doing?** Feel free to send a PR if you'd like.
...
This project is licensed under the Mozilla Public License 2.0 (MPL 2.0). Read the following for more information.
