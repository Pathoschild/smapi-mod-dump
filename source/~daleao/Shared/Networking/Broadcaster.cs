...
public sealed class Broadcaster
{
    ...
    {
        this._helper.SendMessage(message, messageType, [this._modId]);
    }
    ...
    {
        this._helper.SendMessage(message, messageType, [this._modId], [playerId]);
    }
    ...
    {
        this._helper.SendMessage(message, messageType, [modId], [playerId]);
    }
    ...
    public void MessageHost(string? message, string messageType)
    {
        this._helper.SendMessage(
            message, messageType, [this._modId], [Game1.MasterPlayer.UniqueMultiplayerID]);
    }
    ...
    {
        this._helper.SendMessage(
            message, messageType, [modId], [Game1.MasterPlayer.UniqueMultiplayerID]);
    }
