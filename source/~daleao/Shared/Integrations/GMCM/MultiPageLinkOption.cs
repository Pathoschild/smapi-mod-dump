...
public class MultiPageLinkOption<TPage>
{
    ...
    protected readonly Func<TPage, string> GetLinkText;
    ...
    protected virtual void Draw(SpriteBatch b, Vector2 basePosition)
    {
        ...
        foreach (var page in this.Pages)
        {
            var name = this.GetLinkText(page);
            ...
            SpriteText.drawString(
                ...
                (int)valuePosition.Y,
                layerDepth: 1,
                color: hoveringMenu && hoveringValue ? SpriteText.color_Gray : null);
