...
public interface IGenericModConfigMenuAPI
{
    ...
    void AddNumberOption(IManifest mod, Func<int> getValue, Action<int> setValue, Func<string> name,
        Func<string>? tooltip = null, int? min = null, int? max = null, int? interval = null, string? fieldId = null);
    ...
    /// <remarks><see cref="AddPageLink" /> must be called to make the page accessible. This is only needed to set up a multi-page config UI. If this method is not called, all options will be part of the mod's main config UI instead. </remarks>
