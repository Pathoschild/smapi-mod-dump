...
[UsedImplicitly]
internal sealed class BeachGetFishPatcher : HarmonyPatcher
{
    /// <summary>Initializes a new instance of the <see cref="BeachGetFishPatcher"/> class.</summary>
    internal BeachGetFishPatcher()
    {
        ...
        IEnumerable<CodeInstruction> instructions, ILGenerator generator, MethodBase original)
    {
        ...
        try
        {
            ...
            helper
                .Match(new[] { new CodeInstruction(OpCodes.Ldc_I4, Constants.CrimsonfishIndex) })
        ...
        {
            Log.E($"Failed adding prestiged Crimsonfish legendary fish recatch.\nHelper returned {ex}");
            return null;
        }
