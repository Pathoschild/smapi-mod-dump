...
{
    private static readonly int BuffId = (Manifest.UniqueID + "Warrior").GetHashCode();
    ...
    /// <summary>Patch to draw Warrior buff.</summary>
    [HarmonyPostfix]
    private static void BuffsDisplayDrawPostfix(Dictionary<ClickableTextureComponent, Buff> ___buffs, SpriteBatch b)
    {
        ...
        var counter = RingsModule.State.WarriorKillCount;
        b.DrawString(
            Game1.tinyFont,
            counter.ToString(),
            new Vector2(
