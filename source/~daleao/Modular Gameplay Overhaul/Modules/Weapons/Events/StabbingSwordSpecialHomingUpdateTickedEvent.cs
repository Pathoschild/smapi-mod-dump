...
internal sealed class StabbingSwordSpecialHomingUpdateTickedEvent : UpdateTickedEvent
{
    ...
    protected override void OnEnabled()
    {
        ...
        for (var i = 0; i < user.currentLocation.characters.Count; i++)
        {
            ...
            WeaponsModule.State.HoveredEnemy = monster;
            Log.D($"[WPNZ]: Hovering {monster.Name}!");
            return;
        }
    }
    ...
    {
        WeaponsModule.State.HoveredEnemy = null;
        Log.D("[WPNZ]: Hovering no one!");
    }
    ...
    protected override void OnUpdateTickedImpl(object? sender, UpdateTickedEventArgs e)
    {
        ...
        var hoveredEnemy = WeaponsModule.State.HoveredEnemy;
        ...
        Log.D($"[WPNZ]: Auto-turned towards {newDirection}!");
        ...
        Log.D($"[WPNZ]: New trajectory: ({user.xVelocity}, {user.yVelocity})");
