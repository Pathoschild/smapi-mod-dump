...
namespace SkillPrestige.Framework.Menus.Dialogs
{
    ...
    internal class LevelUpMessageDialogWithProfession : LevelUpMessageDialog
    {
        ...
        *********/
        ...
        {
            Vector2 locationOfIconRelativeToButton = new Vector2(professionBounds.Width - (TextPadding + this.Profession.IconSourceRectangle.Width * Game1.pixelZoom), TextPadding);
