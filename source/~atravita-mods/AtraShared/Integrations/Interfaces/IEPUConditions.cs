...
/*********************************************
 * The following file was copied from: https://github.com/ChroniclerCherry/stardew-valley-mods/blob/master/ExpandedPreconditionsUtility/IConditionsChecker.cs.
 *
 * The original license is GPL 3.0 and can be found at: https://github.com/ChroniclerCherry/stardew-valley-mods/blob/master/LICENSE
 *
 * *******************************************/

namespace AtraShared.Integrations.Interfaces;

public interface IEPUConditionsChecker
{
    /// <summary>
