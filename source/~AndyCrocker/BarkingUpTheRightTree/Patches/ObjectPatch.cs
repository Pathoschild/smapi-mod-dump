...
namespace BarkingUpTheRightTree.Patches
{
    ...
    internal static class ObjectPatch
    {
        ...
        ** Internal Methods
        *********/
        /// <summary>The post fix for the <see cref="Object.isWildTreeSeed(int)"/> method.</summary>
        ...
        /// <summary>The transpiler for the <see cref="Object.placementAction(GameLocation, int, int, Farmer)"/> method.</summary>
        /// <param name="instructions">The IL instructions.</param>
        /// <returns>The new IL instructions.</returns>
        /// <remarks>This is used to stop the stop tappers being able to be placed on trees.<br/>This is to make it determine if tappers can be placed on tree in <see cref="ObjectPatch.PlacementActionPrefix(GameLocation, int, int, Object, ref bool)"/> patch, this was done as a <see cref="Object"/> instance can't be retrieved in a transpile but can in a prefix (and as such can't get the tree whether the tree can be tapped).</remarks>
        ...
        /// <summary>The post fix for the <see cref="Object.isPlaceable()"/> method.</summary>
        /// <param name="__instance">The <see cref="Object"/> instance being patched.</param>
        /// <param name="__result">The return value of the method being patched.</param>
        ...
        /// <summary>The post fix for the <see cref="Object.isPassable()"/> method.</summary>
        /// <param name="__instance">The <see cref="Object"/> instance being patched.</param>
        /// <param name="__result">The return value of the method being patched.</param>
