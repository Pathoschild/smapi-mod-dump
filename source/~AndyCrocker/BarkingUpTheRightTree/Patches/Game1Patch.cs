...
{
    /// <summary>Contains patches for patching game code in the <see cref="StardewValley.Game1"/> class.</summary>
    internal static class Game1Patch
    {
        /*********
        ** Internal Methods
        *********/
        /// <summary>The prefix for the <see cref="StardewValley.Game1.createRadialDebris(StardewValley.GameLocation, int, int, int, int, bool, int, bool, int)"/> method.</summary>
