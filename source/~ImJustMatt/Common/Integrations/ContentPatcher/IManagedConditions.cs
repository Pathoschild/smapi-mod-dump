...
public interface IManagedConditions
{
    ...
    *********/
    ...
    /// <summary>
    ///     If <see cref="IsValid" /> is false, an error phrase indicating why the conditions failed to parse, formatted
    ///     like this: <c>'seasonz' isn't a valid token name; must be one of &lt;token list&gt;</c>. If the conditions are
    ///     valid, this is <c>null</c>.
    /// </summary>
    ...
    *********/
    ...
    /// </summary>
    /// <returns>
    ///     Returns the screens for which <see cref="IsMatch" /> changed value. To check if the current screen changed,
