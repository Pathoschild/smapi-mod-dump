            ...
            set
            {
                ...
                for (int i = 0; i < this._totalCells; i++)
                {
                    this._bars[i] = new Rectangle(
                        ...
                        this._area.Top + this._axis switch { Axis.Horizontal => 0, Axis.Vertical => i * this._cellSize, _ => 0 },
                        this._axis switch { Axis.Horizontal => this._cellSize, Axis.Vertical => this._area.Width, _ => 1 },
                        this._axis switch { Axis.Horizontal => this._area.Height, Axis.Vertical => this._cellSize, _ => 1 });
                }
            }
        }
