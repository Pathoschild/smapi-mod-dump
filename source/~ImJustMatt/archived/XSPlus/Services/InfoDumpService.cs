...
internal class InfoDumpService : BaseService
{
    ...
    private InfoDumpService(ServiceLocator serviceLocator)
        : base("InfoDumpService")
    {
        // Init
        this._serviceLocator = serviceLocator;
        serviceLocator.Helper.ConsoleCommands.Add("xs_dump", "Dumps a bunch of info to the logs.", this.DumpInfo);
    ...
    {
        var features = this._serviceLocator.GetAll<BaseFeature>();
