...
{
    private static FieldInfo _ParentAnimal;
    ...
    internal PregnancyControllerAddNewHatchedAnimalPatch()
    {
        try
        {
            var pregnancyControllerType = "AnimalHusbandryMod.animals.PregnancyController".ToType();
            _ParentAnimal = pregnancyControllerType.Field("parentAnimal");

            Original = pregnancyControllerType.MethodNamed("addNewHatchedAnimal");
        }
        catch
        {
            // ignored
