...
#nullable enable
	...
	private readonly PerScreen<bool> IsRollin = new(() => false);
	private readonly PerScreen<bool> IsAnimating = new(() => false);
	private readonly PerScreen<float> Speed = new(() => 0f);
	private readonly PerScreen<bool> OtherFoot = new(() => false);
