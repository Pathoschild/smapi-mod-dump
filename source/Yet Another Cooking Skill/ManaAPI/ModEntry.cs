    ...
    public class ModEntry : StardewModdingAPI.Mod
    {
        ...
        *********/
        ...
        public override void Entry(IModHelper helper)
        {
            ...
            ModEntry.ManaBg = helper.ModContent.Load<Texture2D>("assets/manabg.png");
        ...
        private static void BeginDrawManaBar(SpriteBatch e)
        {
            ...
            int barBottomPosition = ModEntry.ManaBg.Height - barHeaderHeight;
            int drawedBarsHeight = default;

            int overchargeHeight = Convert.ToInt32(Math.Ceiling(GetManaOvercharge() * Config.SizeMultiplier));

            Rectangle srcRect;
            Vector2 topOfBar = new(safeXCoordinate + 3 + Config.XManaBarOffset + ModEntry.barPosition.X,
        ...
        private static Rectangle DrawManaBarBody(SpriteBatch e, int barWidth, int barHeaderHeight, ref int drawedBarsHeight, int overchargeHeight, out Rectangle srcRect, out Rectangle destRect, Vector2 topOfBar)
        {
            ...
            destRect = new Rectangle(Convert.ToInt32(topOfBar.X),
                                     ...
                                     barWidth * 4,
                                     barHeaderHeight + (ModEntry.ManaBg.Height - barHeaderHeight * 2) +
        ...
        private static void DrawManaBarHoverText(SpriteBatch e, int drawedBarsHeight, Vector2 topOfBar)
        {
            ...
            if ((float)Game1.getOldMouseX() >= vector.X && (float)Game1.getOldMouseY() >= vector.Y && (float)Game1.getOldMouseX() < vector.X + 32f)
            {
        ...
        private static int CalculateYOffsetToManaBar(int barHeaderHeight, double oversize, int barBottomPosition)
        {
            ...
            int height = ModEntry.ManaBg.Height;

            height += barHeaderHeight * 2;
            height += (ModEntry.ManaBg.Height - barHeaderHeight * 2) + Convert.ToInt32(oversize * Game1.pixelZoom);
