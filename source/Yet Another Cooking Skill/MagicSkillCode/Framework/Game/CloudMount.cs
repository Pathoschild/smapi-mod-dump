...
namespace MagicSkillCode.Framework.Game
{
    public class CloudMount : Horse
    {
        ...
        ** Fields
        *********/
        private readonly Texture2D Tex = ModEntry.Assets.CloudMount;
        ...
        *********/
        ...
        public override bool checkAction(Farmer who, GameLocation l)
        {
            ...
            if (!tileForCharacter.Equals(Vector2.Zero) /*&& (double)Vector2.Distance(tileForCharacter, this.rider.getTileLocation()) < 2.0*/)
            {
                ...
                this.dismounting.Value = true;
                ModEntry.Instance.Helper.Reflection.GetField<Vector2>(this, "dismountTile").SetValue(tileForCharacter);
