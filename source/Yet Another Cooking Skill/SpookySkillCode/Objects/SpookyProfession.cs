...
namespace SpookySkillCode.Objects
{
    public class SpookyProfession : Skills.Skill.Profession
    {
        ...
        public SpookyProfession(Skills.Skill skill, string id, Texture2D icon, ITranslationHelper i18n, object tokens = null) : base(skill, id)
        {
            this.Icon = icon;
            this.I18n = i18n;
            this.Tokens = tokens;
        ...
        public SpookyProfession(Skills.Skill skill, string id, Texture2D icon, Texture2D prestigeIcon, IModHelper modHelper, object tokens = null) : base(skill, id)
        {
            this.Icon = icon;
        ...
        public override string GetDescription()
        {
            ...
            if (CheckPrestigeMenu())
            {
                ...
                {
                    return this.I18n.Get($"{this.Id}.Thief.desc", this.Tokens);
                }
                else
                {
                    return this.I18n.Get($"{this.Id}.Scary.desc", this.Tokens);
                }
            }
            else
            {
        ...
        public override string GetName()
        {
            if (ModEntry.Config.DeScary)
            {
                return this.I18n.Get($"{this.Id}.Thief.name", this.Tokens);
            } else
            {
                return this.I18n.Get($"{this.Id}.Scary.name", this.Tokens);
            }
        }
    }
}
