...
namespace Revitalize.Magic.Alchemy.Menus
{
    public class ExpandableItemGrabMenu : MenuWithInventory
    {
        ...
        private ExpandableItemGrabMenu.behaviorOnItemSelect behaviorFunction;

        public ExpandableItemGrabMenu.behaviorOnItemSelect behaviorOnItemGrab;
        ...
        public Revitalize.Objects.Generic.ExpandableInventoryObject expandableObject;

        public ExpandableItemGrabMenu(Revitalize.Objects.Generic.ExpandableInventoryObject ExpandableObject,List<Item> inventory, int rows) : base(null, true, true, 0, 0)
        {
        ...
        {
            this.expandableObject = ExpandableObject;
            this.source = source;
        ...
        public void getNextInventory(bool getPrevious)
        {
            if (getPrevious == false)
            {
                if (expandableObject.inventoryIndex < expandableObject.allInventories.Count - 1)
                {
                    ...
                    Game1.activeClickableMenu = new ExpandableItemGrabMenu(this.expandableObject, expandableObject.inventory, this.Rows, false, true, new InventoryMenu.highlightThisItem(InventoryMenu.highlightAllItems), this.behaviorFunction, null, this.behaviorOnItemGrab, false, true, true, true, true, this.source, this.sourceItem);
                    return;
                }
                else
                {
