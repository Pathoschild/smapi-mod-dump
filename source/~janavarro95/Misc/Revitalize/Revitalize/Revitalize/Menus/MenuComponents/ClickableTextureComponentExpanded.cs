...
{
    public class ClickableTextureComponentExpanded : ClickableTextureComponent
    {
        ...
        public ClickableTextureComponentExpanded(string name, Rectangle bounds, string label, string hoverText, Texture2D texture, Rectangle sourceRect, float scale, int value, bool drawShadow = false) : base(name,bounds,label,hoverText,texture,sourceRect,scale,drawShadow)
        {
        ...
        public ClickableTextureComponentExpanded(Rectangle bounds, Texture2D texture, Rectangle sourceRect, float scale,int value, bool drawShadow = false) : this("", bounds, "", "", texture, sourceRect, scale,value, drawShadow)
        {
        }
