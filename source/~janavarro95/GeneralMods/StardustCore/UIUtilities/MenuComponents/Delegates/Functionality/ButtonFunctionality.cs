...
{
    /// <summary>
    /// Holds all of the functionality for handeling what happens with button interactivity.
    /// </summary>
    public class ButtonFunctionality
    {
        /// <summary>
        /// Handles functions that run when a button is left clicked.
        /// </summary>
        public DelegatePairing leftClick;
        /// <summary>
        /// Handles functions that run when a button is right clicked.
        /// </summary>
        public DelegatePairing rightClick;
        /// <summary>
        /// Handles functions that run when a button is being hovered over.
        /// </summary>
