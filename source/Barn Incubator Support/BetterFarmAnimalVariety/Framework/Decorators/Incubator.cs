...
// Type: BetterFarmAnimalVariety.Framework.Decorators.Incubator
...
{
  internal class Incubator : Decorator
  {
    public Incubator(Object original)
      : base(original)
    {
    }
    ...
    {
      return Paritee.StardewValley.Core.Locations.AnimalHouse.GetRandomTypeFromIncubator(GetOriginal(), restrictions) ??
             Paritee.StardewValley.Core.Characters.FarmAnimal.GetDefaultCoopDwellerType();
    }
  }
}