    ...
    abstract class Patch
    {
        ...
        private void ApplyPatch(HarmonyInstance harmonyInstance)
        {
            ...
            MethodBase targetMethod = String.IsNullOrEmpty(patchDescriptor.targetMethodName) ?
                ...
                (patchDescriptor.targetMethodArguments == null ? (MethodBase)patchDescriptor.targetType.GetConstructors()[0] : 
                ...
                targetMethod = patchDescriptor.targetMethodArguments != null ?
                    patchDescriptor.targetType.GetMethod(patchDescriptor.targetMethodName, ((BindingFlags)62), null,CallingConventions.Any,patchDescriptor.targetMethodArguments, new ParameterModifier[0])
