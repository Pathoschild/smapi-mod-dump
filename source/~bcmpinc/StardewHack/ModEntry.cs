...
namespace StardewHack.Library
{
    public class ModEntry : Mod
    {
        ...
        public override void Entry(IModHelper helper) {
            ...
            CheckIncompatible(helper, "bcmpinc.AlwaysScrollMap",    new SemanticVersion(2,4,0));
            CheckIncompatible(helper, "bcmpinc.CraftCounter",       new SemanticVersion(2,4,0));
            CheckIncompatible(helper, "bcmpinc.FixAnimalTools",     new SemanticVersion(2,4,0));
            CheckIncompatible(helper, "bcmpinc.GrassGrowth",        new SemanticVersion(2,4,0));
            CheckIncompatible(helper, "bcmpinc.HarvestWithScythe",  new SemanticVersion(2,4,0));
            CheckIncompatible(helper, "bcmpinc.MovementSpeed",      new SemanticVersion(2,4,0));
            CheckIncompatible(helper, "bcmpinc.TilledSoilDecay",    new SemanticVersion(2,4,0));
            CheckIncompatible(helper, "bcmpinc.TreeSpread",         new SemanticVersion(2,4,0));
            CheckIncompatible(helper, "bcmpinc.WearMoreRings",      new SemanticVersion(2,4,0));
            CheckIncompatible(helper, "spacechase0.BiggerBackpack", new SemanticVersion(2,4,0));
