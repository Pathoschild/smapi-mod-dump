    ...
    public class Crate : EventHandle
    {
        ...
        public override void EventTrigger()
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                int X = Mod.instance.rite.randomIndex.Next(3, layerWidth - 3);

                int Y = Mod.instance.rite.randomIndex.Next(3, layerHeight - 3);
        ...
        public void TreasureGlyph()
        {
            ...
            TemporaryAnimatedSprite radiusAnimation = new(0, 4000, 1, 1, treasureVector * 64 - new Vector2(16, 16), false, false)
            {
                ...
                //texture = Mod.instance.Helper.ModContent.Load<Texture2D>(Path.Combine("Images", "Ether.png")),
