...
namespace StardewDruid.Event.World
{
    public class Polymorph : EventHandle
    {
        ...
        public Polymorph(Vector2 target, Rite rite, StardewValley.Monsters.Monster Monster)
            : base(target, rite)
        {
        ...
        public override void EventDecimal()
        {
            ...
            animations[0].alpha = 0.4f + (decimalCounter * 0.01f);
        ...
        public override void EventInterval()
        {
            ...
            if(activeCounter == 6)
            {
                ...
                Vector2 spawnAt = victim.getTileLocation();
                ...
                monsterHandle = new(spawnAt, riteData.castLocation);
