...
{
    internal class RelicsMists : EventHandle
    {
        ...
        public override bool TriggerCheck()
        {
            ...
            if (!Game1.player.hasOrWillReceiveMail("canReadJunimoText"))
            {
                ...
                Mod.instance.CastMessage("The forest spirits left instructions. You can't read them.");
            ...
            if ((Game1.getLocationFromName("CommunityCenter") as CommunityCenter).numberOfCompleteBundles() == 0)
            {
                ...
                Mod.instance.CastMessage("There's no energy around this fish tank yet");
