...
namespace StardewDruid.Monster
{
    public class BossShooter : Shooter
    {
        ...
        public BossShooter(Vector2 position, int combatModifier)
        ...
        public override void behaviorAtGameTick(GameTime time)
        {
            ...
            else if (shootPlayer)
            {
                ...
                for (int i = 0; i < 3; i++)
                {
                    ...
                    BasicProjectile basicProjectile = new BasicProjectile(base.DamageToFarmer, firedProjectile, 0, 0, 0f, vector.X, vector.Y, projectilePosition, "", "", explode: false, damagesMonsters: false, base.currentLocation, this);
        ...
        public override void defaultMovementBehavior(GameTime time)
        {
            ...
            if (posturing && !shiftPosition) { return; }
