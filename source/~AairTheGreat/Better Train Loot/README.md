...
Note: You can still get more or less than the maximum since the game can still create trains 
and you might have a really bad luck day.    
- Default Value: 5 
...
NOTE: This is a dead configuration option as of SDV 1.4.
