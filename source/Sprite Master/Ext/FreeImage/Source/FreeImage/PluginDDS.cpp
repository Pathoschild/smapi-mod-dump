...
LoadRGB(const DDSURFACEDESC2 *desc, FreeImageIO *io, fi_handle handle) {
	FIBITMAP *dib = NULL;
	DDSFormat16 format16 = DDSFormat16::RGB_UNKNOWN;	// for 16-bit formats
