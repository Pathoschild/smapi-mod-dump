...
namespace MTN.Patches.WorldChangeEventPatch
{
    //[HarmonyPatch(typeof(WorldChangeEvent))]
    //[HarmonyPatch("setUp")]
    class setUpPatch
    {
        ...
        /*
        public static void Postfix(WorldChangeEvent __instance, ref bool __result)
        {
            if (!bypass) return;
