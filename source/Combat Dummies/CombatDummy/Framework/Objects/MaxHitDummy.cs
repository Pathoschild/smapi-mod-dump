...
{
    internal class MaxHitDummy
    {
        public static bool IsValid(Object instance)
        {
            if (instance is null || instance.Name != ModDataKeys.MAX_HIT_DUMMY_NAME)
            {
                return false;
            }
        ...
        public static void Draw(Object __instance, SpriteBatch spriteBatch, int x, int y, float alpha)
        {
            ...
            spriteBatch.Draw(CombatDummy.assetManager.MaxHitDummyTexture, destination, new Rectangle(animationFrame * 16, 0, 16, 32), Color.White * alpha, 0f, Vector2.Zero, SpriteEffects.None, __instance.getBoundingBox(new Vector2(x, y)).Bottom / 10000f);
