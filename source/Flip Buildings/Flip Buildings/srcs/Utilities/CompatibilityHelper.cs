...
namespace FlipBuildings.Utilities
{
	internal class CompatibilityHelper
	{
		...
		// Get AT types
		internal static readonly Type FarmPatchType = Type.GetType("AlternativeTextures.Framework.Patches.GameLocations.FarmPatch, AlternativeTextures");
		internal static readonly Type StablePatchType = Type.GetType("AlternativeTextures.Framework.Patches.Buildings.StablePatch, AlternativeTextures");
