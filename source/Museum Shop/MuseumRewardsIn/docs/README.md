...
Most users should download the mod from the [Nexus page](https://www.nexusmods.com/stardewvalley/mods/12598). That said, if you'd like to contribute:
...
3. Fork [this repository](https://github.com/atravita-mods/MuseumRewardsIn).
