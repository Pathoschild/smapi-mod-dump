...
[UsedImplicitly]
internal sealed class MountainGetFishPatcher : HarmonyPatcher
{
    /// <summary>Initializes a new instance of the <see cref="MountainGetFishPatcher"/> class.</summary>
    internal MountainGetFishPatcher()
    {
        ...
        IEnumerable<CodeInstruction> instructions, ILGenerator generator, MethodBase original)
    {
        ...
        try
        {
            ...
            helper
                .Match(new[] { new CodeInstruction(OpCodes.Ldc_I4, Constants.LegendIndex) })
        ...
        {
            Log.E($"Failed adding prestiged Legend legendary fish recatch.\nHelper returned {ex}");
            return null;
        }
