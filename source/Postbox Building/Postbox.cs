...
namespace PostBoxMod
{
    ...
    public class Postbox : Building
    {
        ...
        public Postbox(string type, Vector2 tileLocation) : base(type, tileLocation)
        { 
        }

        public Postbox() : base("Postbox", Vector2.Zero) 
        {
            inUse = false;
            target = "";
        }
        ...
        public override bool doAction(Vector2 tileLocation, Farmer who)
        {
            ...
            if (base.daysOfConstructionLeft.Value <= 0)
            {
                ...
                if (tileLocation.X == (float)(base.tileX.Value + 1) && tileLocation.Y == (float)(base.tileY.Value + 1))
                {
        ...
        public override void draw(SpriteBatch b)
        {
            ...
            this.drawShadow(b);
            b.Draw(base.texture.Value, Game1.GlobalToLocal(Game1.viewport, new Vector2(base.tileX.Value * 64, base.tileY.Value * 64 + base.tilesHigh.Value * 64)), this.baseSourceRect, base.color * base.alpha, 0f, new Vector2(0f, base.texture.Value.Bounds.Height), 4f, SpriteEffects.None, (float)((base.tileY.Value + base.tilesHigh.Value - 1) * 64) / 10000f);
        }
    }
}
