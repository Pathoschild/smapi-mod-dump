...
//Game1.locations[Game1.locations.Count - 1].addCharacter(new NPC(new AnimatedSprite("Characters\\Maru", 0, 16, 32), new Vector2(128f, 256f), "ScienceHouse", 3, "Maru", true, null, Game1.content.Load<Texture2D>("Portraits\\Maru")));
//Game1.locations[Game1.locations.Count - 1].addCharacter(new NPC(new AnimatedSprite("Characters\\Robin", 0, 16, 32), new Vector2(1344f, 256f), "ScienceHouse", 1, "Robin", false, null, Game1.content.Load<Texture2D>("Portraits\\Robin")));
//Game1.locations[Game1.locations.Count - 1].addCharacter(new NPC(new AnimatedSprite("Characters\\Demetrius", 0, 16, 32), new Vector2(1216f, 256f), "ScienceHouse", 1, "Demetrius", false, null, Game1.content.Load<Texture2D>("Portraits\\Demetrius")));
