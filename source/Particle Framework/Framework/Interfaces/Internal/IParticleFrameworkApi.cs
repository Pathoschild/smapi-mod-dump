...
namespace API
{
    ...
    public interface IParticleFrameworkApi
    {
        ...
        /// </summary>
        /// <param name="customDictPath">The custom dictionary path to add.</param>
        public void AddCustomDictPath(string customDictPath);

        /// <summary>
        /// Loads a particle effect.
        /// </summary>
        /// <param name="effectData">The data of the particle effect to load.</param>
        public void LoadEffect(ParticleEffectData effectData);

        /// <summary>
        /// Unloads a particle effect.
        /// </summary>
        /// <param name="key">The key of the particle effect to unload.</param>
