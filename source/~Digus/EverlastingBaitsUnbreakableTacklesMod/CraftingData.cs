...
namespace EverlastingBaitsAndUnbreakableTacklesMod
{
    ...
    {
        public String EverlastingBait;
        public String EverlastingWildBait;
        public String EverlastingMagnet;
        ...
        public String UnbreakableDressedSpinner;

        public CraftingData()
        {
            
            EverlastingBait = "684 10 74 1";
            EverlastingWildBait = "771 100 684 50 766 20 74 1";
            EverlastingMagnet = "335 10 74 1";
            ...
            UnbreakableDressedSpinner = "335 4 428 2 66 1 62 1 60 1 70 1 68 1 64 1 337 5";
        }
    }
}
