...
namespace SplitScreen.Menu
{
	abstract class BaseButton : ClickableComponent
	{
		...
		public virtual void Draw(SpriteBatch spriteBatch)
		{
			...
			IClickableMenu.drawTextureBox(spriteBatch, sourceTexture, sourceRectangle, x - width / 2, y - height / 2, width, height, isDisabled ? Color.SlateGray : Color.White, base.scale, true);
		}
