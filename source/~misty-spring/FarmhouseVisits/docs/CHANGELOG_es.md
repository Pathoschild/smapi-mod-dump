...
- Se cambió cómo funcionan las visitas agregadas por usuarios: se removió "Force", y se agregó "Extras" en su lugar. (ver [aquí](https://github.com/misty-spring/StardewMods/blob/main/FarmhouseVisits/docs/Custom_visits_es.md))
- Se pueden usar condiciones GSQ para las visitas.
- Visitas de usuarios: Se agregó MustBeExact (ver [aquí](https://github.com/misty-spring/StardewMods/blob/main/FarmhouseVisits/docs/Custom_visits_es.md)).
