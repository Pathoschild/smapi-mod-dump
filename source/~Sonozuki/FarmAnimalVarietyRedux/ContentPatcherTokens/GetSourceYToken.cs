...
{
    /// <summary>Represents the "GetSourceY" token for Content Patcher.</summary>
    /// <remarks>Used to get the Y component of the source rectangle of a shop icon.</remarks>
    public class GetSourceYToken
    {
        /*********
        ** Fields
        *********/
        ...
        *********/
        ...
        public IEnumerable<string> GetValues(string input) => new[] { ModEntry.Instance.AssetManager.GetShopIconSourceRectangle(input).Y.ToString() };
