    ...
    public static class MailKeys
    {
        ...
        public static void EditAssets(IDictionary<string, string> mailItems)
        {
            ...
            mailItems[MailKeys.GeorgeSeederMail] = "I hear you're restoring that old tractor.  Here's the seeder - it spreads fertilizer and seeds.  Your Grandpa gave it to me to fix after he decided to try going organic and put chicken droppings in it. "
                                                 + "I got it cleaned up, but it needed some iron bars.  Your Grandpa took his time rounding those up, and, well, my accident and his decline put an end to it.  But you're young, you can find somebody to fix it. "
            ...
            mailItems[MailKeys.LinusFoundShoes] = $"I found shoes in the garbage last night.  You're right, these are perfectly good shoes, ready for a second life!  I hope you give them a good home.%item object {ObjectIds.AlexesOldShoe} 1%%[#]Linus found shoes";
        }
    }
}
