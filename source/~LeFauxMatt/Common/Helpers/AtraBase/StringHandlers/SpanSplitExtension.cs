...
public static class SpanSplitExtension
{
    ...
    public static SpanSplit SpanSplit(
        this string str,
        char[]? splitchars = null,
        StringSplitOptions options = StringSplitOptions.None,
        int? expectedCount = null)
    {
        return new(str, splitchars, options, expectedCount);
    }
    ...
    /// <returns>SpanSplit instance.</returns>
    public static SpanSplit SpanSplit(
        this SpanSplitEntry str,
        char[]? splitchars = null,
        StringSplitOptions options = StringSplitOptions.None,
        int? expectedCount = null)
    {
        return new(str.Word, splitchars, options, expectedCount);
    }
    ...
    public static SpanSplit SpanSplit(
        ...
        int? expectedCount = null)
    {
        return new(str, splitchar, options, expectedCount);
    }
    ...
    public static SpanSplit SpanSplit(
        ...
        int? expectedCount = null)
    {
        return new(str.Word, splitchar, options, expectedCount);
    }
}