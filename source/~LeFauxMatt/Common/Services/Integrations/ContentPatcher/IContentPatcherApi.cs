...
public interface IContentPatcherApi
{
    ...
    /// <para>
    /// The unique IDs of mods whose custom tokens to allow in the <paramref name="rawConditions" />. You don't need to
    /// list the mod identified by <paramref name="manifest" />, mods listed as a required dependency in the
    /// <paramref name="manifest" />, or mods identified by a <c>HasMod</c> condition in the <paramref name="rawConditions" />.
    /// </para>
    /// <para>
    /// NOTE: this is meant to prevent mods from breaking if a player doesn't have a required mod installed. You
    /// shouldn't simply list all installed mods, and parsing conditions will still fail if a mod isn't installed regardless of
    /// the listed mod IDs.
    /// </para>
    /// </param>
