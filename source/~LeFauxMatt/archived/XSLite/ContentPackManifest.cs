...
internal record ContentPackManifest : IManifest
{
    public ContentPackManifest(IManifest manifest)
    {
...
internal record ManifestContentPackFor : IManifestContentPackFor
{
