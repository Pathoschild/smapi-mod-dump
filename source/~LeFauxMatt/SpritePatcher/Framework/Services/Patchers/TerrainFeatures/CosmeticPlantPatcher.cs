...
/// <summary>Patches for <see cref="CosmeticPlant" /> draw methods.</summary>
internal sealed class CosmeticPlantPatcher : BasePatcher
{
    /// <summary>Initializes a new instance of the <see cref="CosmeticPlantPatcher" /> class.</summary>
    ...
    public CosmeticPlantPatcher(
        ...
        this.Patches.Add(
            this.Id,
            new SavedPatch(
                AccessTools.DeclaredMethod(typeof(CosmeticPlant), nameof(CosmeticPlant.draw)),
                AccessTools.DeclaredMethod(typeof(BasePatcher), nameof(BasePatcher.Draw)),
                PatchType.Transpiler));

    /// <inheritdoc />
    public override AllPatches Type => AllPatches.PatchedCosmeticPlant;
}