...
/// <summary>Patches for <see cref="Grass" /> draw methods.</summary>
internal sealed class GrassPatcher : BasePatcher
{
    /// <summary>Initializes a new instance of the <see cref="GrassPatcher" /> class.</summary>
    ...
    public GrassPatcher(
        ...
        this.Patches.Add(
            ...
            new SavedPatch(
                AccessTools.DeclaredMethod(typeof(Grass), nameof(Grass.drawInMenu)),
                AccessTools.DeclaredMethod(typeof(BasePatcher), nameof(BasePatcher.DrawInMenu)),
                PatchType.Transpiler));

    /// <inheritdoc />
    public override AllPatches Type => AllPatches.PatchedGrass;
}