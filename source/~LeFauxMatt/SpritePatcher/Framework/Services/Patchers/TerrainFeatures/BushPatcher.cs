...
/// <summary>Patches for <see cref="Bush" /> draw methods.</summary>
internal sealed class BushPatcher : BasePatcher
{
    /// <summary>Initializes a new instance of the <see cref="BushPatcher" /> class.</summary>
    ...
    public BushPatcher(
        ...
        this.Patches.Add(
            ...
            new SavedPatch(
                AccessTools.DeclaredMethod(typeof(Bush), nameof(Bush.drawInMenu)),
                AccessTools.DeclaredMethod(typeof(BasePatcher), nameof(BasePatcher.DrawInMenu)),
                PatchType.Transpiler));

    /// <inheritdoc />
    public override AllPatches Type => AllPatches.PatchedBush;
}