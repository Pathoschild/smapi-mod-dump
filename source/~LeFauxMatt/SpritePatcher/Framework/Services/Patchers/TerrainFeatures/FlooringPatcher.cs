...
internal sealed class FlooringPatcher : BasePatcher
{
    /// <summary>Initializes a new instance of the <see cref="FlooringPatcher" /> class.</summary>
