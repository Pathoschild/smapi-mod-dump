...
internal sealed class ShippingBinPatcher : BasePatcher
{
    /// <summary>Initializes a new instance of the <see cref="ShippingBinPatcher" /> class.</summary>
