...
/// <summary>Patches for <see cref="Clothing" /> draw methods.</summary>
internal sealed class ClothingPatcher : BasePatcher
{
    /// <summary>Initializes a new instance of the <see cref="ClothingPatcher" /> class.</summary>
    ...
    public ClothingPatcher(
        ...
        this.Patches.Add(
            this.Id,
            new SavedPatch(
                AccessTools.DeclaredMethod(typeof(Clothing), nameof(Clothing.drawInMenu)),
                AccessTools.DeclaredMethod(typeof(BasePatcher), nameof(BasePatcher.DrawInMenu)),
                PatchType.Transpiler));

    /// <inheritdoc />
    public override AllPatches Type => AllPatches.PatchedClothing;
}