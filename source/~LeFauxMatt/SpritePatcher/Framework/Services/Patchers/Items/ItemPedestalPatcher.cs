...
/// <summary>Patches for <see cref="ItemPedestal" /> draw methods.</summary>
internal sealed class ItemPedestalPatcher : BasePatcher
{
    /// <summary>Initializes a new instance of the <see cref="ItemPedestalPatcher" /> class.</summary>
    ...
    public ItemPedestalPatcher(
        ...
        this.Patches.Add(
            this.Id,
            new SavedPatch(
                AccessTools.DeclaredMethod(typeof(ItemPedestal), nameof(ItemPedestal.draw)),
                AccessTools.DeclaredMethod(typeof(BasePatcher), nameof(BasePatcher.Draw)),
                PatchType.Transpiler));

    /// <inheritdoc />
    public override AllPatches Type => AllPatches.PatchedItemPedestal;
}