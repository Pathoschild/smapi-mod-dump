...
/// <summary>Patches for <see cref="Boots" /> draw methods.</summary>
internal sealed class BootsPatcher : BasePatcher
{
    /// <summary>Initializes a new instance of the <see cref="BootsPatcher" /> class.</summary>
    ...
    public BootsPatcher(
        ...
        this.Patches.Add(
            this.Id,
            new SavedPatch(
                AccessTools.DeclaredMethod(typeof(Boots), nameof(Boots.drawInMenu)),
                AccessTools.DeclaredMethod(typeof(BasePatcher), nameof(BasePatcher.DrawInMenu)),
                PatchType.Transpiler));

    /// <inheritdoc />
    public override AllPatches Type => AllPatches.PatchedBoots;
}