...
/// <summary>Patches for <see cref="WoodChipper" /> draw methods.</summary>
internal sealed class WoodChipperPatcher : BasePatcher
{
    /// <summary>Initializes a new instance of the <see cref="WoodChipperPatcher" /> class.</summary>
    ...
    public WoodChipperPatcher(
        ...
        this.Patches.Add(
            this.Id,
            new SavedPatch(
                AccessTools.DeclaredMethod(typeof(WoodChipper), nameof(WoodChipper.draw)),
                AccessTools.DeclaredMethod(typeof(BasePatcher), nameof(BasePatcher.Draw)),
                PatchType.Transpiler));

    /// <inheritdoc />
    public override AllPatches Type => AllPatches.PatchedWoodChipper;
}