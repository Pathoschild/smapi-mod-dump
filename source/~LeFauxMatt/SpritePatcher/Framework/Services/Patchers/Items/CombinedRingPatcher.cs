...
internal sealed class CombinedRingPatcher : BasePatcher
{
    /// <summary>Initializes a new instance of the <see cref="CombinedRingPatcher" /> class.</summary>
