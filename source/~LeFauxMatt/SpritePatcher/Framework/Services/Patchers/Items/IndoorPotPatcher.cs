...
internal sealed class IndoorPotPatcher : BasePatcher
{
    /// <summary>Initializes a new instance of the <see cref="IndoorPotPatcher" /> class.</summary>
