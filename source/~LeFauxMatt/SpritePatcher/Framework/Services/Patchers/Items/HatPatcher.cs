...
/// <summary>Patches for <see cref="Hat" /> draw methods.</summary>
internal sealed class HatPatcher : BasePatcher
{
    /// <summary>Initializes a new instance of the <see cref="HatPatcher" /> class.</summary>
    ...
    public HatPatcher(
        ...
        this.Patches.Add(
            this.Id,
            new SavedPatch(
                AccessTools.DeclaredMethod(typeof(Hat), nameof(Hat.draw)),
                AccessTools.DeclaredMethod(typeof(BasePatcher), nameof(BasePatcher.Draw)),
                PatchType.Transpiler),
            new SavedPatch(
                AccessTools.DeclaredMethod(typeof(Hat), nameof(Hat.drawInMenu)),
                AccessTools.DeclaredMethod(typeof(BasePatcher), nameof(BasePatcher.DrawInMenu)),
                PatchType.Transpiler));

    /// <inheritdoc />
    public override AllPatches Type => AllPatches.PatchedHat;
}