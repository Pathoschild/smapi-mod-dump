...
/// <summary>Patches for <see cref="FishTankFurniture" /> draw methods.</summary>
internal sealed class FishTankFurniturePatcher : BasePatcher
{
    /// <summary>Initializes a new instance of the <see cref="FishTankFurniturePatcher" /> class.</summary>
    ...
    public FishTankFurniturePatcher(
        ...
        this.Patches.Add(
            this.Id,
            new SavedPatch(
                AccessTools.DeclaredMethod(typeof(FishTankFurniture), nameof(FishTankFurniture.draw)),
                AccessTools.DeclaredMethod(typeof(BasePatcher), nameof(BasePatcher.Draw)),
                PatchType.Transpiler));

    /// <inheritdoc />
    public override AllPatches Type => AllPatches.PatchedFishTankFurniture;
}