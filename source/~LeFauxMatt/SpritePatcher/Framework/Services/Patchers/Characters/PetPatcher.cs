...
/// <summary>Patches for <see cref="Pet" /> draw methods.</summary>
internal sealed class PetPatcher : BasePatcher
{
    /// <summary>Initializes a new instance of the <see cref="PetPatcher" /> class.</summary>
    ...
    public PetPatcher(
        ...
        this.Patches.Add(
            this.Id,
            new SavedPatch(
                AccessTools.DeclaredMethod(typeof(Pet), nameof(Pet.draw)),
                AccessTools.DeclaredMethod(typeof(BasePatcher), nameof(BasePatcher.Draw)),
                PatchType.Transpiler));

    /// <inheritdoc />
    public override AllPatches Type => AllPatches.PatchedPet;
}