...
internal sealed class SlingshotPatcher : BasePatcher
{
    /// <summary>Initializes a new instance of the <see cref="SlingshotPatcher" /> class.</summary>
